...
| HEAD | `8e6eb4bf` (F4.W3 4 tests corrupt cache recovery, JOURNAL §125.V32.3) sobre `5cf287bc` (F4.W2 3 tests binary restart, JOURNAL §125.V32.2) sobre `dca87b7e` (D75 corregir 5 docstrings F3, JOURNAL §125.V32.2) sobre `e3a7e7db` (V32.1 corrección D66, JOURNAL §125.V32.1) sobre `dc3f4abd` (F4.W1 3 tests workspace isolation).
