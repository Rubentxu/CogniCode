...
| HEAD | `e4ad0080` (force-add AUDIT tracker) sobre `bdc80e11` (JOURNAL §138) sobre `e2bbd86a` (STATE for §137) sobre `11a128a5` (ci: docs-isolation guard) sobre `c2b2924d` (recovery) sobre `d40e61b2` (tag/workspace gate) sobre `cb9a77af` (release v0.98.0) sobre `8505ad85` (workspace bump) sobre `fadee2c2` (audit ack). Tag `v0.98.0` → `d99d3911…`. |
