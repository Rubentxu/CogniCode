...
| HEAD | `dd4201d8` (F5.W4 timeout top-level + F6.W3 install/update/rollback, JOURNAL §125.V32.7+V32.8) sobre `3a0147e9` (F6.W3 install/update/execute/rollback/uninstall cycle) sobre `da906678` (workflow fix merge-multiple + F6.W2 staging contract 5/5) sobre `c28f2143` (F6.W1 release coherence) sobre `8e6eb4bf` (F4.W3 4 tests corrupt cache recovery, JOURNAL §125.V32.3) sobre `5cf287bc` (F4.W2 3 tests binary restart, JOURNAL §125.V32.2) sobre `dca87b7e` (D75 corregir 5 docstrings F3, JOURNAL §125.V32.2) sobre `e3a7e7db` (V32.1 corrección D66, JOURNAL §125.V32.1) sobre `dc3f4abd` (F4.W1 3 tests workspace isolation). |
