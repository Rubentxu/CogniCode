...
| HEAD | about to be `e2bbd86a + this commit` (F6.W3.fifth §138 audit tracker + STATE snapshot) sobre `e2bbd86a` (STATE for §137) sobre `11a128a5` (ci: docs-isolation guard) sobre `c2b2924d` (recovery) sobre `d40e61b2` (tag/workspace gate) sobre `cb9a77af` (release v0.98.0) sobre `8505ad85` (workspace bump) sobre `fadee2c2` (audit ack). Tag `v0.98.0` → `d99d3911…`. |
| Working tree | §137 + this STATE.md snapshot staged together; commit pending (`11a128a5` + this commit). After commit/push, working tree should be clean (modulo operator-managed `.pipeline.kts`, `ci/`). |
