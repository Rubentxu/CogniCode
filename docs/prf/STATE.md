...
| HEAD | `dca87b7e` (D75 corregir 5 docstrings F3, JOURNAL §125.V32.2) sobre `e3a7e7db` (V32.1 corrección D66, JOURNAL §125.V32.1) sobre `dc3f4abd` (F4.W1 3 tests workspace isolation). **F4.W2 integration test nuevo** (3 tests bit-a-bit restart) pending commit.
