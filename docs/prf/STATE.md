...
| Hito activo | **F4 — Persistencia, fuentes de verdad y aislamiento (EN CURSO; sub-cerrados en JOURNAL §95 DIST-03, §99-§100 H-06 PRF-DIST-02/U20, §103-§104 T4/S5, §125.V22 commits V12+V13+IssueJ, §125.V23 H-07 cláusula, §125.V32-V32.2 D75+F4.W2). Operator-gated: push, tag, C7, H-05, H-06.** |
...
| Unidad activa siguiente | Decisión AUTO sin push. Pendiente operator-gated: push acumulado (9 commits: `a5183ce6`, `d4969ccb`, `8967849d`, `ad86ec13`, `788109a2`, `cc60f20f`, `4b70f1bc`, `3d87a4b0`, `8b1f998c`), tag v0.97.6, H-05/H-06, C7 firma, solicitud SEPARADA de remote-validate (sin tag). Las tres garantías pendientes del operador tras §128 (recovery observable, F5.W4.bis real-timeout, audit release-validate.yml con negative-test) están cerradas en producto. Falta la confirmación dinámica de los negative-test en CI remoto, que es una autorización separada. |
...
| Working tree | 6 entradas restantes tras commits `4b56c27f` + `d5ca08fa` + `788109a2` + `cc60f20f` + `4b70f1bc` + `3d87a4b0` + `8b1f998c`: archivos operator-managed o gitignored (`.tool-versions`, `AGENTS.md`, `docs/prf/*` gitignored, `.pipeline.kts`, `ci/run-pipelinek`). 6 archivos modificados en `crates/cognicode-cli/{src,tests}/` no commiteados en esta sesión — corresponden a trabajo de sesiones anteriores, no a cambios de esta sesión. Cero código CogniCode relativo a F6.W3.bis / F5.W4.bis / release-validate.yml sin commitear. Push acumulado + tag pendientes — operator-gated. |
