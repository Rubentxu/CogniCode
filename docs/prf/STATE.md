...
| HEAD | `628abd71` (chore: bump 0.97.5, JOURNAL §125.V31). Sobre `cc785c71` (STATE update V30) sobre `5fa42733` (D71(c) doc intencional 5 enums, JOURNAL §125.V30) sobre `be42ed0d` (D65(b) doc divergencia, JOURNAL §125.V29) sobre `5dbb3bcd` (D66 nota uniforme F3) sobre `6d90c751` (D66+D69 propuesta cierre F3, JOURNAL §125.V28.2) sobre `499e76aa` (D71 cinco implementaciones risk_level, JOURNAL §125.V28.1) sobre `90ace55a` (STATE update) sobre `27d272c5` (F3.W5 get_call_hierarchy MCP contract, JOURNAL §125.V28) sobre `bddc94f0` (STATE update) sobre `2a4e7437` (F3.W4 analyze_impact MCP contract, JOURNAL §125.V27) sobre `70f402b9` (STATE update) sobre `98768030` (F3.W3 get_outline equivalence, JOURNAL §125.V26) sobre `d1f99137` (V25, F3.W2 query_symbol_index equivalence) sobre `f3adb2ea` (V24, F3.W1.a per_file_equivalence) sobre `d5ca08fa` (JOURNAL §125.V22, commits materializados) sobre `4b56c27f` (V12+V13 ROFS+large-manifest tests) sobre `fd1c9235` (§125 hardening) sobre `5cf910a7` (§124 fix tmp_path_for) sobre `ee834ff4` (§123 scope-aware aplicado) sobre `dac62c0a` (§122 workflow). **23 commits locales sin push** sobre origin/main. **Tag remoto: v0.97.5** (anotado, push OK). |
