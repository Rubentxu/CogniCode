...
| Siguiente unidad ejecutable | En AUTO: siguientes NOT_RUN (candidatos: PRF-STATE-07 aviso de reconstrucción; U21 corte durante escritura; PRF-DIST-04 supervivencia IDE en uninstall). Operator-gated: acciones 4-5 + H-04/H-06/H-07 + enforcement CI automático. |
