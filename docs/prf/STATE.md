...
| Unidad activa siguiente | 2026-09-22 (AUTO): cerradas U21/PRF-DIST-04 (§48, stale lock takeover), PRF-ANA-06 (§49, basis identity), PRF-CLI-02 (§50, stdio split), PRF-CLI-05 (§51, refactor crash + --apply gate). HEAD bc7f85a8. Siguientes NOT_RUN/PARTIAL accionables: PRF-CI-02 (campañas nightly), PRF-CI-03 (coverage gate), PRF-CI-05 (SBOM), U03/G6 (flakiness layout/lifecycle). **Operator-gated**: push/tag, re-publish v0.97.3 (artefactos públicos con SHA256SUMS stale), firma C7, H-04/H-06/H-07. |
