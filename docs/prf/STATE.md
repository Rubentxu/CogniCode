...
| HEAD | `2a4e7437` (F3.W4 analyze_impact MCP contract, JOURNAL §125.V27). Sobre `70f402b9` (STATE update) sobre `98768030` (F3.W3 get_outline equivalence, JOURNAL §125.V26) sobre `d1f99137` (V25, F3.W2 query_symbol_index equivalence) sobre `f3adb2ea` (V24, F3.W1.a per_file_equivalence) sobre `d5ca08fa` (JOURNAL §125.V22, commits materializados) sobre `4b56c27f` (V12+V13 ROFS+large-manifest tests) sobre `fd1c9235` (§125 hardening) sobre `5cf910a7` (§124 fix tmp_path_for) sobre `ee834ff4` (§123 scope-aware aplicado) sobre `dac62c0a` (§122 workflow). **11 commits locales sin push** desde origin/main. Tag `v0.97.4` en remoto (apunta a `4129ae4a`); tag para §125+ pendiente — operator-gated. |
