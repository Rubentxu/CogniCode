...
| Siguiente unidad ejecutable | En AUTO: siguientes NOT_RUN (candidatos: PRF-SEC-03 logs sin secretos con verbose alta; PRF-MCP-01 cliente externo; U03 baseline/goldens dobles). Operator-gated: acciones 4-5 + H-04/H-07 + enforcement CI automático. |
