...
CogniCode ha acumulado 40+ ciclos SDDK, ~2.800 tests Rust, 401 requirements openspec, 956 escenarios y 75 MCP tools (runtime `tools/list`: 20 en `cognicode-mcp` + 55 en `explorer-mcp`, 2026-09-21). El roadmap funcional (E28, E29, E12-E21) está mayormente completo. El riesgo restante no es de features: es de **verificación de producción** — ¿funciona de verdad contra repositorios reales, a escala, de forma estable?
...
| G2 | Cobertura MCP tools en sandbox | 100% de N tools con ≥1 scenario (N = runtime tools/list, 75 = 20 + 55; sin feature multimodal activa) | matriz de cobertura auto-generada |
...
| G11 | Documentación al día | MCP-TOOLS regenerado de tools/list (75); ADRs revisados; ROADMAP reconciliado | auditoría docs |
