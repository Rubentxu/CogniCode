...
### B1. `retrieve_and_verify` CV 0.105 (real outlier)

- **Source**: E31-E (read_file CV 0.528 outlier decision)
- **Decision**: deferred (separate cycle, E31-E2 or E31-F-rollup)
- **Note**: this is NOT cold-cache (post E31-E filter). Requires a real
  investigation of why `retrieve_and_verify` has a real CV > 10%.
- **Impact**: G6 scorecard may show this tool as a top outlier; the
  warm-cache filter does not help.
