...
declare_rule! {
    ...
    explanation: "[AUTORESEARCH] Add placeholder/example value detection to skip false positives from test fixtures and example code. This catches cases where values like 'changeme', ",
    ...
    check: => {
        ...
        let patterns = [
            ...
            (r#"(?i)(bearer\s+token|basic\s+auth)\s*[=:]\s*["'][a-zA-Z0-9_\-]{6,}["']"#, "bearer_token"),
        ];
