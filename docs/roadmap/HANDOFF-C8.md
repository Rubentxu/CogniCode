...
* **Workspace**: 5557 tests passed, 0 failed, 45 ignored en HEAD actual (ver `git rev-parse HEAD`).
...
*HEAD: ver `git rev-parse HEAD` (este doc se versiona junto al workspace, no a sí mismo).*
