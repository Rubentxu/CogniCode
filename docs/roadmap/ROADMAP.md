...
| **PR-PERF** | e91 Graph Insights G5 GREEN + regression budget | **PENDING → IN PROGRESS_PARTIAL** (e91.W1-W6 `CLOSED 2026-09-26` con metadata-honesty + profiling discipline; **e91.W7 / CR-05** `CLOSED 2026-09-26` con regression budget gate contractual: `e91_w7_regression_budget_tier2` asserts ≤30 s en Tier-2 (1000 nodos / ~3000 edges); baseline @ HEAD dev = 619 ms (50× bajo budget). Wired en pr-ci merge-gate como L3.W5. Falta CR-03 (profiling per-stage con fixture multi-repo), CR-04 (optimización basada en profiling), G5 GREEN scorecard + streak ≥3 ejecuciones consecutivas.) |
