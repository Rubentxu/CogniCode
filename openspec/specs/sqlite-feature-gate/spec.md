# sqlite-feature-gate Specification (OBSOLETE — 2026-08-04)

> **Status: OBSOLETE** — SQLite (rusqlite) was removed along with PostgreSQL.
> The stack now uses LadybugDB only. This spec's gating logic for sqlite
> vs postgres backends is no longer applicable. Archive this spec.
