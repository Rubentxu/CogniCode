# ci-postgres-pipeline Specification (OBSOLETE — 2026-08-04)

> **Status: OBSOLETE** — PostgreSQL removed from CI and stack (ADR-026, e29-7).
> `TEST_DATABASE_URL` and PG service are no longer part of the pipeline.
> Archive this spec.
