//! Correlation id — groups one logical operation across actors.
//!
//! **Ungated general execution vocabulary (cycle e64).** It was introduced by
//! the event log but it identifies an *execution*, not an event, so it lives
//! with the rest of the execution identity. `intelligence_log::ids` re-exports
//! it.
