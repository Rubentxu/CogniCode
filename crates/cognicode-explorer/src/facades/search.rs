                        ...
                        for node in page.items {
                            results.push(SpotterSearchResult::Doc(SpotterResult {
                                object: InspectableObjectSummary {
                                    ...
                                    subtitle: node.source_path.unwrap_or_else(|| "Graph node".to_string()),
                                    properties: Vec::new(),
                        ...
                        for node in page.items {
                            results.push(SpotterSearchResult::Decision(SpotterResult {
                                object: InspectableObjectSummary {
                                    ...
                                    label: node.label.clone(),
                                    subtitle: node.source_path.unwrap_or_else(|| "Decision artifact".to_string()),
                                    properties: Vec::new(),
                        ...
                        for node in page.items {
                            results.push(SpotterSearchResult::Evidence(SpotterResult {
                                object: InspectableObjectSummary {
                                    ...
                                    label: node.label.clone(),
                                    subtitle: node.source_path.unwrap_or_else(|| "Evidence node".to_string()),
                                    properties: Vec::new(),
